          ...
          <card class="card-login card-white bg-vitevini">
            ...
            <div>
              <div class="d-flex mb-3 flex-column">
                ...
                <h5>Inserisci la tua mail per ricevere istruzioni su come creare la tua password.</h5>
              </div>
              <ValidationProvider
              ...
              <div v-if="success">
                <label class="success white">
                  È stata inviata un'email con le istruzioni per impostare la password.
                </label>
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...mapActions({
      forgotPassword: 'auth/firstAccess'
    }),
    submit () {
      this.loading = true
