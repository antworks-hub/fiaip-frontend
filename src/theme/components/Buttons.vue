        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="card-body">
              ...
              >
                Success
              </base-button>&nbsp; <base-button type="warning">
                Warning
              </base-button>&nbsp;
          ...
          <div class="col-md-6">
            ...
            <div class="card-body">
              <base-button>
                <i class="tim-icons icon-minimal-left" /> Left
              </base-button>
              &nbsp;

              <base-button>
                Right <i class="tim-icons icon-minimal-right" />
              </base-button>
              &nbsp;

              <base-button type="info">
                <i class="tim-icons icon-alert-circle-exc" /> Info
              </base-button>
              <br>
              <base-button type="success">
                <i class="tim-icons icon-check-2" /> Success
              </base-button>
              &nbsp;

              <base-button type="warning">
                <i class="tim-icons icon-time-alarm" /> Warning
              </base-button>
              &nbsp;

              <base-button type="danger">
                <i class="tim-icons icon-simple-remove" /> Danger
              </base-button>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="card-body">
              ...
              <base-button type="primary" size="lg">
                Large
              </base-button>
            </div>
          </div>
          <div class="col-md-6">
            ...
            <div class="card-body">
              ...
              <base-button type="primary" round>
                <i slot="label" class="tim-icons icon-heart-2" /> with icon
              </base-button>
              <base-button type="primary" round icon>
                <i class="tim-icons icon-heart-2" />
              </base-button>
              <base-button type="primary" simple>
                Simple
              </base-button>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-4 col-sm-5">
              <button class="btn btn-google">
                <i class="fab fa-google-plus-g" /> Share on Google+
              </button>
            </div>
            <div class="col-md-1 col-sm-1">
...
<script>
import { BasePagination } from 'src/theme/components'
