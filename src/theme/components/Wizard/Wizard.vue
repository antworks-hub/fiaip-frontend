  ...
  <div class="wizard-container">
    ...
    <div id="wizardProfile" class="card card-wizard active">
      <form @submit.prevent>
        ...
        -->
        <div class="card-header text-center pl-0 pr-0">
          <slot name="header">
            <h3 v-if="title" class="card-title">
              {{ title }}
            </h3>
            <h5 v-if="subTitle" class="description">
              {{ subTitle }}
            </h5>
          </slot>
          ...
          <card class="mb-0" v-if="hasTopSummary">
            <div class="col-12 text-left">
              <slot name="topSummary" />
            </div>
            <div v-if="!showCustomButtons" class="col-12 mt-4">
              <div class="pull-right">
                <base-button v-if="activeTabIndex < tabCount - 1" type="primary" wide class="btn-next" @click.native="nextTab">
                  {{ nextButtonText }}
                </base-button>
              </div>
